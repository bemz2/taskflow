...
type TaskRepository interface {
	...
	GetTask(ctx context.Context, id, userID uuid.UUID) (repository.TaskModel, error)
	...
	UpdateTaskStatus(ctx context.Context, id, userID uuid.UUID, status string) error
}
